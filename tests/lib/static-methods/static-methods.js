...
ruleTester.run("ES6 Numbers", rule, {
  ...
  invalid: [
    ...
    },
    {
      ...
      errors: [
        { message: "Method getOwnPropertySymbols not supported by IE 11" }
      ]
    },
    {
...
const settings = {
  ieStaticMethodsAllow: {
    Object: ["assign"],
    Number: ["MIN_SAFE_INTEGER", "parseFloat"]
  }
};
var settingsRuleTester = new RuleTester({ settings: settings });

settingsRuleTester.run("settings test", rule, {
  valid: ["Object.assign()", "Number.MIN_SAFE_INTEGER", "Number.parseFloat()"],
